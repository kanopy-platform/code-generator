...
func GenerateSetterForEmbeddedSlice(root *types.Type, parent *types.Type, member types.Member, inputType *types.Type) (string, generator.Args) {
	args := generator.Args{
		"type":           root,
		"funcName":       funcName(member),
		"memberAccessor": member.Name,
...
func GenerateSetterForEmbeddedStruct(root *types.Type, parent *types.Type, member types.Member, inputType *types.Type) (string, generator.Args) {
	args := generator.Args{
		"type":           root,
		"funcName":       funcName(member),
		"memberAccessor": member.Name,
