...
func GenerateEmptyConstructor(t *types.Type, isPointer bool) (string, generator.Args) {
	args := generator.Args{
		"type": t,
	}

	argsForPointer(args, isPointer)
...
func GenerateConstructorForObjectMeta(t *types.Type, isPointer bool) (string, generator.Args) {
	args := generator.Args{
		"type": t,
	}
